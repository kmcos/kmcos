...
! Enable processes
    ...
    case(empty)
        call add_proc(oxygen_diffusion_cus_bridge_rig0000, cell + (/ 0, -1, 0, 1/), gr_oxygen_diffusion_cus_bridge_rig0000(cell + (/ 0, -1, 0, 0/)))
    case(oxygen)
        call add_proc(oxygen_desorption_bridge_cus_le0000, cell + (/ 1, -1, 0, 1/), gr_oxygen_desorption_bridge_cus_le0000(cell + (/ 1, -1, 0, 0/)))
    case(co)
        call add_proc(reaction_oxygen_cus_co_bridge_r0000, cell + (/ 0, -1, 0, 1/), gr_reaction_oxygen_cus_co_bridge_r0000(cell + (/ 0, -1, 0, 0/)))
    end select
    ...
    case(empty)
        call add_proc(oxygen_diffusion_cus_cus_down, cell + (/ 0, -1, 0, 1/), gr_oxygen_diffusion_cus_cus_down(cell + (/ 0, -1, 0, 0/)))
    case(oxygen)
        call add_proc(oxygen_desorption_cus_cus, cell + (/ 0, -2, 0, 1/), gr_oxygen_desorption_cus_cus(cell + (/ 0, -2, 0, 0/)))
    case(co)
