...
subroutine run_proc_oxygen_desorption_bridge_cus_le0000(cell)
...
! Enable processes
    ...
    call add_proc(co_adsorption_cus, cell + (/ -1, 0, 0, 1/), gr_co_adsorption_cus(cell + (/ -1, 0, 0, 0/)))
...
end subroutine run_proc_oxygen_desorption_bridge_cus_le0000

end module run_proc_0018
