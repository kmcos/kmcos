...
! Disable processes
    ...
    if(can_do(oxygen_desorption_bridge_bridge,cell + (/ 1, 0, 0, 1/))) then
        call del_proc(oxygen_desorption_bridge_bridge,cell + (/ 1, 0, 0, 1/))
    end if
    if(can_do(oxygen_desorption_bridge_bridge,cell + (/ 1, -1, 0, 1/))) then
        call del_proc(oxygen_desorption_bridge_bridge,cell + (/ 1, -1, 0, 1/))
    end if
    ...
    if(can_do(oxygen_diffusion_bridge_bridge_0000,cell + (/ 1, 0, 0, 1/))) then
        call del_proc(oxygen_diffusion_bridge_bridge_0000,cell + (/ 1, 0, 0, 1/))
    end if
    ...
    if(can_do(oxygen_diffusion_bridge_bridge_0001,cell + (/ 1, 0, 0, 1/))) then
        call del_proc(oxygen_diffusion_bridge_bridge_0001,cell + (/ 1, 0, 0, 1/))
    end if
    ...
    if(can_do(reaction_oxygen_bridge_co_bridg0000,cell + (/ 1, 0, 0, 1/))) then
        call del_proc(reaction_oxygen_bridge_co_bridg0000,cell + (/ 1, 0, 0, 1/))
    end if
    if(can_do(reaction_oxygen_bridge_co_bridg0001,cell + (/ 1, 0, 0, 1/))) then
        call del_proc(reaction_oxygen_bridge_co_bridg0001,cell + (/ 1, 0, 0, 1/))
    end if
...
! Enable processes
    ...
    call add_proc(co_desorption_bridge, cell + (/ 1, 0, 0, 1/), gr_co_desorption_bridge(cell + (/ 1, 0, 0, 0/)))
