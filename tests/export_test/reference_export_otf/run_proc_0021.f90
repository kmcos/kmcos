...
subroutine run_proc_oxygen_diffusion_bridge_bridge_0000(cell)
...
! Enable processes
    ...
    case(empty)
        call add_proc(oxygen_diffusion_bridge_bridge_0000, cell + (/ 0, -1, 0, 1/), gr_oxygen_diffusion_bridge_bridge_0000(cell + (/ 0, -1, 0, 0/)))
    case(oxygen)
        call add_proc(oxygen_desorption_bridge_bridge, cell + (/ 0, -2, 0, 1/), gr_oxygen_desorption_bridge_bridge(cell + (/ 0, -2, 0, 0/)))
    case(co)
...
end subroutine run_proc_oxygen_diffusion_bridge_bridge_0000
