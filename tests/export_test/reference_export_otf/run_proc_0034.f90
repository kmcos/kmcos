...
subroutine run_proc_reaction_oxygen_cus_co_bridge_r0000(cell)
...
! Enable processes
    ...
    call add_proc(co_adsorption_bridge, cell + (/ 1, 0, 0, 1/), gr_co_adsorption_bridge(cell + (/ 1, 0, 0, 0/)))
...
end subroutine run_proc_reaction_oxygen_cus_co_bridge_r0000

end module run_proc_0034
