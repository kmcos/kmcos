...
subroutine run_proc_oxygen_diffusion_bridge_cus_lef0000(cell)
...
! Disable processes
    ...
    if(can_do(co_adsorption_cus,cell + (/ -1, 0, 0, 1/))) then
        call del_proc(co_adsorption_cus,cell + (/ -1, 0, 0, 1/))
    end if
    ...
    if(can_do(co_diffusion_cus_cus_up,cell + (/ -1, -1, 0, 1/))) then
        call del_proc(co_diffusion_cus_cus_up,cell + (/ -1, -1, 0, 1/))
    end if
    ...
    if(can_do(oxygen_adsorption_cus_cus,cell + (/ -1, -1, 0, 1/))) then
        call del_proc(oxygen_adsorption_cus_cus,cell + (/ -1, -1, 0, 1/))
    end if
    ...
    if(can_do(reaction_oxygen_cus_co_cus_up,cell + (/ -1, -1, 0, 1/))) then
        call del_proc(reaction_oxygen_cus_co_cus_up,cell + (/ -1, -1, 0, 1/))
    end if
...
! Enable processes
    ...
    case(empty)
        call add_proc(oxygen_diffusion_cus_cus_up, cell + (/ -1, 0, 0, 1/), gr_oxygen_diffusion_cus_cus_up(cell + (/ -1, 0, 0, 0/)))
    case(oxygen)
        call add_proc(oxygen_desorption_cus_cus, cell + (/ -1, 0, 0, 1/), gr_oxygen_desorption_cus_cus(cell + (/ -1, 0, 0, 0/)))
    case(co)
        call add_proc(reaction_oxygen_cus_co_cus_up, cell + (/ -1, 0, 0, 1/), gr_reaction_oxygen_cus_co_cus_up(cell + (/ -1, 0, 0, 0/)))
    end select

    select case(get_species(cell + (/-1, -1, 0, ruo2_cus/)))
    case(empty)
        call add_proc(oxygen_diffusion_cus_cus_down, cell + (/ -1, 0, 0, 1/), gr_oxygen_diffusion_cus_cus_down(cell + (/ -1, 0, 0, 0/)))
    case(oxygen)
        call add_proc(oxygen_desorption_cus_cus, cell + (/ -1, -1, 0, 1/), gr_oxygen_desorption_cus_cus(cell + (/ -1, -1, 0, 0/)))
    case(co)
        call add_proc(reaction_oxygen_cus_co_cus_down, cell + (/ -1, 0, 0, 1/), gr_reaction_oxygen_cus_co_cus_down(cell + (/ -1, 0, 0, 0/)))
    end select


end subroutine run_proc_oxygen_diffusion_bridge_cus_lef0000

end module run_proc_0023
