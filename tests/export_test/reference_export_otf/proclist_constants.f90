...
integer(kind=iint), parameter, public :: oxygen_adsorption_bridge_cus_le0000 = 14
integer(kind=iint), parameter, public :: oxygen_adsorption_bridge_cus_ri0000 = 15
...
integer(kind=iint), parameter, public :: oxygen_desorption_bridge_cus_le0000 = 18
integer(kind=iint), parameter, public :: oxygen_desorption_bridge_cus_ri0000 = 19
integer(kind=iint), parameter, public :: oxygen_desorption_cus_cus = 20
integer(kind=iint), parameter, public :: oxygen_diffusion_bridge_bridge_0000 = 21
integer(kind=iint), parameter, public :: oxygen_diffusion_bridge_bridge_0001 = 22
integer(kind=iint), parameter, public :: oxygen_diffusion_bridge_cus_lef0000 = 23
integer(kind=iint), parameter, public :: oxygen_diffusion_bridge_cus_rig0000 = 24
integer(kind=iint), parameter, public :: oxygen_diffusion_cus_bridge_lef0000 = 25
integer(kind=iint), parameter, public :: oxygen_diffusion_cus_bridge_rig0000 = 26
...
integer(kind=iint), parameter, public :: reaction_oxygen_bridge_co_bridg0000 = 29
integer(kind=iint), parameter, public :: reaction_oxygen_bridge_co_bridg0001 = 30
integer(kind=iint), parameter, public :: reaction_oxygen_bridge_co_cus_l0000 = 31
integer(kind=iint), parameter, public :: reaction_oxygen_bridge_co_cus_r0000 = 32
integer(kind=iint), parameter, public :: reaction_oxygen_cus_co_bridge_l0000 = 33
integer(kind=iint), parameter, public :: reaction_oxygen_cus_co_bridge_r0000 = 34
