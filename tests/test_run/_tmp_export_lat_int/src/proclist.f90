...
subroutine touchup_cell(cell)
    ...
    call add_proc(nli_AB_react_down(cell), site)
    call add_proc(nli_AB_react_left(cell), site)
    call add_proc(nli_AB_react_right(cell), site)
    call add_proc(nli_AB_react_up(cell), site)
    call add_proc(nli_A_adsorption(cell), site)
    call add_proc(nli_A_desorption(cell), site)
    call add_proc(nli_B_adsorption(cell), site)
    call add_proc(nli_B_desorption(cell), site)
