...
implicit none
contains
subroutine run_proc_AB_react_up(cell)
    ...
    call del_proc(nli_AB_react_down(cell + (/+0, +2, +0, 0/)), cell + (/+0, +2, +0, 1/))
    ...
    call add_proc(nli_AB_react_down(cell + (/+0, +2, +0, 0/)), cell + (/+0, +2, +0, 1/))
...
end subroutine run_proc_AB_react_up
