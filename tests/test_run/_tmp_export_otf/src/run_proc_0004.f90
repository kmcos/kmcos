...
! Disable processes
    ...
    if(can_do(AB_react_down,cell + (/ 0, 2, 0, 1/))) then
        call del_proc(AB_react_down,cell + (/ 0, 2, 0, 1/))
    end if
    ...
    if(can_do(AB_react_left,cell + (/ 1, 1, 0, 1/))) then
        call del_proc(AB_react_left,cell + (/ 1, 1, 0, 1/))
    end if
    if(can_do(AB_react_left,cell + (/ 0, 1, 0, 1/))) then
        call del_proc(AB_react_left,cell + (/ 0, 1, 0, 1/))
    end if
    if(can_do(AB_react_left,cell + (/ 0, 0, 0, 1/))) then
        call del_proc(AB_react_left,cell + (/ 0, 0, 0, 1/))
    end if
    if(can_do(AB_react_right,cell + (/ -1, 1, 0, 1/))) then
        call del_proc(AB_react_right,cell + (/ -1, 1, 0, 1/))
    end if
    if(can_do(AB_react_right,cell + (/ -1, 0, 0, 1/))) then
        call del_proc(AB_react_right,cell + (/ -1, 0, 0, 1/))
    end if
    if(can_do(AB_react_right,cell + (/ 0, 1, 0, 1/))) then
        call del_proc(AB_react_right,cell + (/ 0, 1, 0, 1/))
    end if
    ...
    if(can_do(A_desorption,cell + (/ 0, 1, 0, 1/))) then
        call del_proc(A_desorption,cell + (/ 0, 1, 0, 1/))
    end if
    if(can_do(A_desorption,cell + (/ 0, 0, 0, 1/))) then
        call del_proc(A_desorption,cell + (/ 0, 0, 0, 1/))
    end if
    if(can_do(B_desorption,cell + (/ 0, 1, 0, 1/))) then
        call del_proc(B_desorption,cell + (/ 0, 1, 0, 1/))
    end if
...
! Enable processes
    ...
    call add_proc(A_adsorption, cell + (/ 0, 1, 0, 1/), gr_A_adsorption(cell + (/ 0, 1, 0, 0/)))
    call add_proc(A_adsorption, cell + (/ 0, 0, 0, 1/), gr_A_adsorption(cell + (/ 0, 0, 0, 0/)))
    call add_proc(B_adsorption, cell + (/ 0, 1, 0, 1/), gr_B_adsorption(cell + (/ 0, 1, 0, 0/)))
