...
expectedResult = [0.0016526261976523228, 0.0005618929072018084]
...
import numpy as np
import importlib
importlib.import_module("runfile__acc_backend__do_acc_steps") #can't use "import runfile_non-acc-backend" because of the dashes.
