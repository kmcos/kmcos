...
integer(kind=iint), parameter, public :: Rh211 = 0
integer(kind=iint), public :: default_layer = Rh211
integer(kind=iint), public :: substrate_layer = Rh211

 ! Site constants

real(kind=rsingle), dimension(3,3), public :: unit_cell_size = 0.
real(kind=rsingle), dimension(3, 3), public :: site_positions
integer(kind=iint), parameter, public :: Rh211_s = 1
integer(kind=iint), parameter, public :: Rh211_t = 2
integer(kind=iint), parameter, public :: Rh211_f = 3
