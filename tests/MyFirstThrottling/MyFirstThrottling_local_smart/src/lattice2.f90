...
!******
integer(kind=iint), parameter, public :: Site = 0
integer(kind=iint), public :: default_layer = Site
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = Site
...
!******
integer(kind=iint), parameter, public :: Site_coord = 1
...
!******
    ...
    IF( ALLOCATED(nr2lattice) )  DEALLOCATE( nr2lattice ) 
