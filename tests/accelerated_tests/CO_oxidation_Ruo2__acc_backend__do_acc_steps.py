...
name = 'CO_oxidation_Ruo2__acc_backend__do_acc_steps'
...
kmcos.export(pt.filename + ' -b ' + pt.backend + acceleration) #alternatively, one can use: kmcos.cli.main('export '+  pt.filename + ' -b' + pt.backend)
