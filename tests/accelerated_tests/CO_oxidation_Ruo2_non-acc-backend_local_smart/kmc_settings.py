model_name = 'CO_oxidation_Ruo2_non-acc-backend'
simulation_size = 20
random_seed = 1
...
xml = """<?xml version="1.0" ?>
<kmc version="(0, 3)">
    <meta author="Mie Andersen" debug="0" email="mieand@gmail.com" model_dimension="2" model_name="CO_oxidation_Ruo2_non-acc-backend"/>
