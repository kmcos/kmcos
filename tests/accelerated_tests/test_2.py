...
import os
ModelName = "CO_oxidation_Ruo2__acc_backend__do_steps" 
backend = 'local_smart'
...
import numpy as np
import importlib
importlib.import_module("runfile_acc-backend_do-steps") #can't use "import runfile_non-acc-backend" because of the dashes.
