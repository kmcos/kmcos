...
pt = Project()
pt.set_meta(author = 'Andreas Garhammer',
...
a_2 = pt.lattice.generate_coord('a_2.(0,0,0).default') #a_2.(0,0,0).lto: tetra.l.2 in der Zelle 000 von lto
