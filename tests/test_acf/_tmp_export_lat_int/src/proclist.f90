...
subroutine touchup_cell(cell)
    ...
    call add_proc(nli_a_1_a_2(cell), site)
    call add_proc(nli_a_1_b_1(cell), site)
    call add_proc(nli_a_1_b_2(cell), site)
    call add_proc(nli_a_2_a_1(cell), site)
    call add_proc(nli_a_2_b_1(cell), site)
    call add_proc(nli_a_2_b_2(cell), site)
    call add_proc(nli_b_1_a_1(cell), site)
    call add_proc(nli_b_1_a_2(cell), site)
    call add_proc(nli_b_1_b_2(cell), site)
    call add_proc(nli_b_2_a_1(cell), site)
    call add_proc(nli_b_2_a_2(cell), site)
    call add_proc(nli_b_2_b_1(cell), site)
