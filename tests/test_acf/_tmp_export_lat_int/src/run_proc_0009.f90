...
implicit none
contains
subroutine run_proc_b_2_a_1(cell)
    ...
    call del_proc(nli_a_1_b_2(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    ...
    call del_proc(nli_b_2_a_1(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    ...
    call add_proc(nli_a_1_b_2(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
