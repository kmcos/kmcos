...
!   unit cell.
!******
real(kind=rsingle), dimension(4, 3), public :: site_positions
!****v* lattice/site_positions
! FUNCTION
!   The positions of (adsorption) site in the unit cell in
!   fractional coordinates.
!******
integer(kind=iint), parameter, public :: default_a_1 = 1
integer(kind=iint), parameter, public :: default_a_2 = 2
integer(kind=iint), parameter, public :: default_b_1 = 3
integer(kind=iint), parameter, public :: default_b_2 = 4

integer(kind=iint), parameter, public :: spuck = 4
!****v* lattice/spuck
! FUNCTION
...
!******
    ...
    site_positions(1,:) = (/0.25, 0.25, 0.5/)
    site_positions(2,:) = (/0.75, 0.25, 0.5/)
    site_positions(3,:) = (/0.25, 0.75, 0.5/)
    site_positions(4,:) = (/0.75, 0.75, 0.5/)
