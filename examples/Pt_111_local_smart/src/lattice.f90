...
!******
    ...
    unit_cell_size(1, 1) = 2.77185858
    unit_cell_size(1, 2) = 0.0
    unit_cell_size(1, 3) = 0.0
    unit_cell_size(2, 1) = 1.38592929
    unit_cell_size(2, 2) = 2.40049995
    unit_cell_size(2, 3) = 0.0
    unit_cell_size(3, 1) = 0.0
    unit_cell_size(3, 2) = 0.0
    unit_cell_size(3, 3) = 26.78963917
    site_positions(1,:) = (/0.333333333333, 0.333333333333, 0.672/)
    site_positions(2,:) = (/0.666666666667, 0.666666666667, 0.672/)
