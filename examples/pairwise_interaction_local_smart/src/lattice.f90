...
!******
integer(kind=iint), parameter, public :: simplecubic_2d = 0
integer(kind=iint), public :: default_layer = simplecubic_2d
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = simplecubic_2d
...
!******
integer(kind=iint), parameter, public :: simplecubic_2d_a = 1
