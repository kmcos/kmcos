...
lattice_representation = """[Atoms(symbols='Pt4',
          ...
          cell=np.array(      ([[2.7718585822512662, 0.0, 0.0], [1.3859292911256331, 2.400499947927514, 0.0], [0.0, 0.0, 26.78963916567]])),
...
<kmc version="(0, 3)">
    ...
    <parameter_list/>
    <lattice cell_size="2.7718585822512662 0.0 0.0 1.3859292911256331 2.400499947927514 0.0 0.0 0.0 26.78963916567" default_layer="pt111" representation="[Atoms(symbols='Pt4',
          pbc=np.array([ True,  True, False]),
          cell=np.array(      ([[2.7718585822512662, 0.0, 0.0], [1.3859292911256331, 2.400499947927514, 0.0], [0.0, 0.0, 26.78963916567]])),
          scaled_positions=np.array(      [[0.0, 0.0, 0.3732786], [0.3333333, 0.3333333, 0.4577595], [0.6666667, 0.6666667, 0.5422405], [0.0, 0.0, 0.6267214]]),
),]" substrate_layer="pt111">
        <layer color="#ffffff" name="pt111">
            <site default_species="default_species" pos="0.33333333333333337 0.3333333333333333 0.672" tags="" type="hollow1"/>
            <site default_species="default_species" pos="0.6666666666666667 0.6666666666666666 0.672" tags="" type="hollow2"/>
        </layer>
    </lattice>
    <process_list>
