...
!******
integer(kind=iint), parameter, public :: pt111 = 0
integer(kind=iint), public :: default_layer = pt111
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = pt111
...
!******
integer(kind=iint), parameter, public :: pt111_hollow1 = 1
integer(kind=iint), parameter, public :: pt111_hollow2 = 2
...
!******
    ...
    unit_cell_size(1, 1) = 2.7718585822512662
    unit_cell_size(1, 2) = 0.0
    unit_cell_size(1, 3) = 0.0
    unit_cell_size(2, 1) = 1.3859292911256331
    unit_cell_size(2, 2) = 2.400499947927514
    unit_cell_size(2, 3) = 0.0
    unit_cell_size(3, 1) = 0.0
    unit_cell_size(3, 2) = 0.0
    unit_cell_size(3, 3) = 26.78963916567
    site_positions(1,:) = (/0.33333333333333337, 0.3333333333333333, 0.672/)
    site_positions(2,:) = (/0.6666666666666667, 0.6666666666666666, 0.672/)
