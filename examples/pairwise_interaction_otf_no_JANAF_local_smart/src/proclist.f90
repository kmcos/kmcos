...
integer(kind=iint), parameter, public :: O_adsorption = 3
integer(kind=iint), parameter, public :: O_desorption = 4
...
!******
    ...
    if (.not. no_banner) then
        print *, "+------------------------------------------------------------+"
        print *, "|                                                            |"
        print *, "| This kMC Model 'pairwise_interaction_otf_no_JANAF' was written by |"
        print *, "|                                                            |"
