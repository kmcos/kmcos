...
sps = 12 # <-- this is just an example
n_snapshots = 8 # <-- this is just an example
...
print("The simulation is done. Kmcos is now creating images and a movie for this example, the image and movie creation is a slower process. \n\n")
