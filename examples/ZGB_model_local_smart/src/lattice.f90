...
!******
integer(kind=iint), parameter, public :: sc = 0
integer(kind=iint), public :: default_layer = sc
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = sc
...
!******
integer(kind=iint), parameter, public :: sc_site = 1
