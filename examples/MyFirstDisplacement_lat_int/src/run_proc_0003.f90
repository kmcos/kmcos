...
implicit none
contains
subroutine run_proc_exc_right_up(cell)
    ...
    call del_proc(nli_hop_left(cell + (/+2, +1, +0, 0/)), cell + (/+2, +1, +0, 1/))
    ...
    call add_proc(nli_hop_left(cell + (/+2, +1, +0, 0/)), cell + (/+2, +1, +0, 1/))
...
end subroutine run_proc_exc_right_up
