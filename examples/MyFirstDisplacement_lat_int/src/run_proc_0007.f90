...
implicit none
contains
subroutine run_proc_hop_up(cell)
    ...
    call del_proc(nli_exc_left_down(cell + (/+1, +2, +0, 0/)), cell + (/+1, +2, +0, 1/))
    ...
    call del_proc(nli_exc_right_down(cell + (/-1, +2, +0, 0/)), cell + (/-1, +2, +0, 1/))
    ...
    call del_proc(nli_hop_down(cell + (/+0, +2, +0, 0/)), cell + (/+0, +2, +0, 1/))
    ...
    call add_proc(nli_exc_left_down(cell + (/+1, +2, +0, 0/)), cell + (/+1, +2, +0, 1/))
    ...
    call add_proc(nli_exc_right_down(cell + (/-1, +2, +0, 0/)), cell + (/-1, +2, +0, 1/))
    ...
    call add_proc(nli_hop_down(cell + (/+0, +2, +0, 0/)), cell + (/+0, +2, +0, 1/))
...
end subroutine run_proc_hop_up
