...
implicit none
contains
subroutine run_proc_hop_left(cell)
    ...
    call del_proc(nli_exc_left_up(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    ...
    call del_proc(nli_exc_right_down(cell + (/-2, +1, +0, 0/)), cell + (/-2, +1, +0, 1/))
    call del_proc(nli_exc_right_down(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    call del_proc(nli_exc_right_up(cell + (/-1, -1, +0, 0/)), cell + (/-1, -1, +0, 1/))
    call del_proc(nli_exc_right_up(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    call del_proc(nli_exc_right_up(cell + (/-2, -1, +0, 0/)), cell + (/-2, -1, +0, 1/))
    call del_proc(nli_exc_right_up(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    call del_proc(nli_hop_down(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    call del_proc(nli_hop_down(cell + (/-1, +1, +0, 0/)), cell + (/-1, +1, +0, 1/))
    ...
    call del_proc(nli_hop_right(cell + (/-2, +0, +0, 0/)), cell + (/-2, +0, +0, 1/))
    call del_proc(nli_hop_right(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    call del_proc(nli_hop_up(cell + (/-1, -1, +0, 0/)), cell + (/-1, -1, +0, 1/))
    call del_proc(nli_hop_up(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    ...
    call replace_species(cell + (/-1, 0, 0, default_a/), empty, Au)
    ...
    call add_proc(nli_exc_left_up(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    ...
    call add_proc(nli_exc_right_down(cell + (/-2, +1, +0, 0/)), cell + (/-2, +1, +0, 1/))
    call add_proc(nli_exc_right_down(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    call add_proc(nli_exc_right_up(cell + (/-1, -1, +0, 0/)), cell + (/-1, -1, +0, 1/))
    call add_proc(nli_exc_right_up(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    call add_proc(nli_exc_right_up(cell + (/-2, -1, +0, 0/)), cell + (/-2, -1, +0, 1/))
    call add_proc(nli_exc_right_up(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    call add_proc(nli_hop_down(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    call add_proc(nli_hop_down(cell + (/-1, +1, +0, 0/)), cell + (/-1, +1, +0, 1/))
    ...
    call add_proc(nli_hop_right(cell + (/-2, +0, +0, 0/)), cell + (/-2, +0, +0, 1/))
    call add_proc(nli_hop_right(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))
    call add_proc(nli_hop_up(cell + (/-1, -1, +0, 0/)), cell + (/-1, -1, +0, 1/))
    call add_proc(nli_hop_up(cell + (/-1, +0, +0, 0/)), cell + (/-1, +0, +0, 1/))
    call add_proc(nli_hop_up(cell + (/+0, -1, +0, 0/)), cell + (/+0, -1, +0, 1/))
    call add_proc(nli_hop_up(cell + (/+0, +0, +0, 0/)), cell + (/+0, +0, +0, 1/))

end subroutine run_proc_hop_left
