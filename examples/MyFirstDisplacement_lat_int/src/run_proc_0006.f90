...
implicit none
contains
subroutine run_proc_hop_right(cell)
    ...
    call del_proc(nli_exc_left_down(cell + (/+2, +1, +0, 0/)), cell + (/+2, +1, +0, 1/))
    ...
    call del_proc(nli_exc_left_up(cell + (/+2, -1, +0, 0/)), cell + (/+2, -1, +0, 1/))
    ...
    call del_proc(nli_hop_left(cell + (/+2, +0, +0, 0/)), cell + (/+2, +0, +0, 1/))
    ...
    call add_proc(nli_exc_left_down(cell + (/+2, +1, +0, 0/)), cell + (/+2, +1, +0, 1/))
    ...
    call add_proc(nli_exc_left_up(cell + (/+2, -1, +0, 0/)), cell + (/+2, -1, +0, 1/))
    ...
    call add_proc(nli_hop_left(cell + (/+2, +0, +0, 0/)), cell + (/+2, +0, +0, 1/))
...
end subroutine run_proc_hop_right
