...
implicit none
contains
subroutine run_proc_exc_left_up(cell)
    ...
    call del_proc(nli_exc_left_down(cell + (/+0, +2, +0, 0/)), cell + (/+0, +2, +0, 1/))
    call del_proc(nli_exc_left_down(cell + (/+1, +1, +0, 0/)), cell + (/+1, +1, +0, 1/))
    ...
    call del_proc(nli_hop_right(cell + (/-2, +1, +0, 0/)), cell + (/-2, +1, +0, 1/))
    ...
    call replace_species(cell + (/-1, 1, 0, default_a/), empty, Au)
    ...
    call add_proc(nli_exc_left_down(cell + (/+0, +2, +0, 0/)), cell + (/+0, +2, +0, 1/))
    call add_proc(nli_exc_left_down(cell + (/+1, +1, +0, 0/)), cell + (/+1, +1, +0, 1/))
    ...
    call add_proc(nli_hop_right(cell + (/-2, +1, +0, 0/)), cell + (/-2, +1, +0, 1/))
...
end subroutine run_proc_exc_left_up
