...
kmc_model.add_parameter(name='E_react_Ocus_CObridge', value=1.2)
kmc_model.add_parameter(name='E_react_Obridge_COcus', value=0.8)
...
cus_left = kmc_model.lattice.generate_coord('bridge.(0,0,0).ruo2')

cus_up = kmc_model.lattice.generate_coord('cus.(0,1,0).ruo2')
cus_down = kmc_model.lattice.generate_coord('cus.(0,-1,0).ruo2')

bridge = kmc_model.lattice.generate_coord('bridge.(0,0,0).ruo2')
bridge_right = kmc_model.lattice.generate_coord('cus.(0,0,0).ruo2')
bridge_left = kmc_model.lattice.generate_coord('cus.(-1,0,0).ruo2')

bridge_up = kmc_model.lattice.generate_coord('bridge.(0,1,0).ruo2')
bridge_down = kmc_model.lattice.generate_coord('bridge.(0,-1,0).ruo2')
...
kmc_model.save('CO_oxidation.ini')
kmc_model.save('CO_oxidation.xml')
