...
preexp_dict = None # Current snapshot
preexp_dict_reg_old = None # Regularized pre-exponentials from the last snapshot
...
__var_list__ = ['print_throttling_info', 'aggregate_throttling_factors',
    ...
    'max_rate_constant', 'max_time', 'Nsites', 'preexp_dict',
    'preexp_dict_reg_old', 'qe_tolerance', 'ranked_uEF_list',
