...
!******
integer(kind=iint), parameter, public :: Ce1 = 0
integer(kind=iint), public :: default_layer = Ce1
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = Ce1
...
!   unit cell.
!******
real(kind=rsingle), dimension(10, 3), public :: site_positions
!****v* lattice/site_positions
! FUNCTION
!   The positions of (adsorption) site in the unit cell in
!   fractional coordinates.
!******
integer(kind=iint), parameter, public :: Ce1_atop_Ce1 = 1
integer(kind=iint), parameter, public :: Ce1_atop_Ce2 = 2
integer(kind=iint), parameter, public :: Ce1_atop_O1 = 3
integer(kind=iint), parameter, public :: Ce1_atop_O2 = 4
integer(kind=iint), parameter, public :: Ce1_bridge_O_O_2_p0_p0_p0 = 5
integer(kind=iint), parameter, public :: Ce1_bridge_O_O_1_p0_p0_p0 = 6
integer(kind=iint), parameter, public :: Ce1_bridge_O_O_3_p0_p0_p0 = 7
integer(kind=iint), parameter, public :: Ce1_bridge_O_O_4_p0_p0_p0 = 8
integer(kind=iint), parameter, public :: Ce1_bridge_O_O_6_p0_p0_p0 = 9
integer(kind=iint), parameter, public :: Ce1_bridge_O_O_5_p0_p0_p0 = 10

integer(kind=iint), parameter, public :: spuck = 10
!****v* lattice/spuck
! FUNCTION
...
!******
    ...
    unit_cell_size(1, 1) = 3.825
    unit_cell_size(1, 2) = 0.0
    unit_cell_size(1, 3) = 0.0
    unit_cell_size(2, 1) = 0.0
    unit_cell_size(2, 2) = 6.626
    unit_cell_size(2, 3) = 0.0
    unit_cell_size(3, 1) = 0.0
    unit_cell_size(3, 2) = 0.0
    unit_cell_size(3, 3) = 2.343
    site_positions(1,:) = (/0.5, 0.8337, 0.5/)
    site_positions(2,:) = (/0.0, 0.3333, 0.5/)
    site_positions(3,:) = (/0.0, 0.0, 1.0/)
    site_positions(4,:) = (/0.5, 0.5, 1.0/)
    site_positions(5,:) = (/0.25, 0.25, 1.0/)
    site_positions(6,:) = (/0.5, 0.0, 1.0/)
    site_positions(7,:) = (/0.75, 0.25, 1.0/)
    site_positions(8,:) = (/1.0, 0.5, 1.0/)
    site_positions(9,:) = (/0.25, 0.75, 1.0/)
    site_positions(10,:) = (/0.75, 0.75, 1.0/)
