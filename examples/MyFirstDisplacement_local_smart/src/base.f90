...
!    print *, "BASE/determine_procsite before avail_sites"
!    print *,"    BASE/determine_procsite/RAN_PROC",ran_proc
!    print *,"    BASE/determine_procsite/RAN_site",ran_site
!    print *,"    BASE/determine_procsite/PROC",proc
!    print *,"    BASE/determine_procsite/SITE",site
...
!    print *, "BASE/determine_procsite after avail_sites"
!    print *,"    BASE/determine_procsite/RAN_PROC",ran_proc
!    print *,"    BASE/determine_procsite/RAN_site",ran_site
!    print *,"    BASE/determine_procsite/PROC",proc
!    print *,"    BASE/determine_procsite/SITE",site
