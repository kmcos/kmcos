...
!******
integer(kind=iint), parameter, public :: simple_cubic = 0
integer(kind=iint), public :: default_layer = simple_cubic
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = simple_cubic
...
!   unit cell.
!******
real(kind=rsingle), dimension(3, 3), public :: site_positions
!****v* lattice/site_positions
! FUNCTION
!   The positions of (adsorption) site in the unit cell in
!   fractional coordinates.
!******
integer(kind=iint), parameter, public :: simple_cubic_hollow1 = 1
integer(kind=iint), parameter, public :: simple_cubic_hollow2 = 2
integer(kind=iint), parameter, public :: simple_cubic_hollow3 = 3

integer(kind=iint), parameter, public :: spuck = 3
!****v* lattice/spuck
! FUNCTION
