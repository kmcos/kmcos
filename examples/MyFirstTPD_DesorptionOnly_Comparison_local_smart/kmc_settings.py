model_name = 'MyFirstTPD_DesorptionOnly_Comparison'
simulation_size = 20
random_seed = 1
...
parameters = {
    ...
    "A_CO_des":{"value":"10000000000000.0", "adjustable":False, "min":"0.0", "max":"0.0","scale":"linear"},
    "E_act_des":{"value":"500000", "adjustable":False, "min":"0.0", "max":"0.0","scale":"linear"},
    "R":{"value":"8.3145", "adjustable":False, "min":"0.0", "max":"0.0","scale":"linear"},
...
xml = """<?xml version="1.0" ?>
<kmc version="(0, 3)">
    <meta author="Christa Cody" debug="0" email="codycn@ornl.gov" model_dimension="2" model_name="MyFirstTPD_DesorptionOnly_Comparison"/>
    ...
    <parameter_list>
        ...
        <parameter adjustable="False" max="0.0" min="0.0" name="A_CO_des" scale="linear" value="10000000000000.0"/>
        <parameter adjustable="False" max="0.0" min="0.0" name="E_act_des" scale="linear" value="500000"/>
