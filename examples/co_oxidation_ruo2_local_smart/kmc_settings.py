...
xml = """<?xml version="1.0" ?>
<kmc version="(0, 3)">
    <meta author="Max J. Hoffmann" debug="0" email="mjhoffmann@gmail.com" model_dimension="2" model_name="CO_oxidation_Ruo2"/>
    ...
    <parameter_list>
        ...
        <parameter adjustable="False" max="0.0" min="0.0" name="E_react_Obridge_COcus" scale="linear" value="0.8"/>
        <parameter adjustable="False" max="0.0" min="0.0" name="E_react_Ocus_CObridge" scale="linear" value="1.2"/>
        <parameter adjustable="False" max="0.0" min="0.0" name="E_react_Ocus_COcus" scale="linear" value="0.9"/>
        <parameter adjustable="True" max="1500.0" min="300.0" name="T" scale="linear" value="450"/>
        <parameter adjustable="True" max="100.0" min="1e-13" name="p_COgas" scale="log" value="1"/>
        <parameter adjustable="True" max="100.0" min="1e-13" name="p_O2gas" scale="log" value="1"/>
    </parameter_list>
    ...
    <process_list>
        ...
        <process enabled="True" name="COdiff_bridge_left" rate_constant="(beta*h)**(-1)*exp(-beta*(E_COdiff_bridge_cus)*eV)">
            <condition coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="CO"/>
        ...
        <process enabled="True" name="COdiff_cus_left" rate_constant="(beta*h)**(-1)*exp(-beta*(E_COdiff_cus_bridge)*eV)">
            <condition coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0" species="CO"/>
            <condition coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="empty"/>
            <action coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0" species="empty"/>
            <action coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="CO"/>
        ...
        <process enabled="True" name="Odiff_bridge_left" rate_constant="(beta*h)**(-1)*exp(-beta*(E_Odiff_bridge_cus)*eV)">
            <condition coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="O"/>
            <condition coord_layer="ruo2" coord_name="cus" coord_offset="-1 0 0" species="empty"/>
            <action coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="empty"/>
        ...
        <process enabled="True" name="Odiff_cus_left" rate_constant="(beta*h)**(-1)*exp(-beta*(E_Odiff_cus_bridge)*eV)">
            <condition coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0" species="O"/>
            <condition coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="empty"/>
            <action coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0" species="empty"/>
            <action coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="O"/>
        ...
        <process enabled="True" name="React_bridge_left" rate_constant="(beta*h)**(-1)*exp(-beta*E_react_Obridge_COcus*eV)" tof_count="{'CO_oxidation': 1}">
            <condition coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="O"/>
        ...
        <process enabled="True" name="React_cus_left" rate_constant="(beta*h)**(-1)*exp(-beta*E_react_Ocus_CObridge*eV)" tof_count="{'CO_oxidation': 1}">
            <condition coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0" species="O"/>
            <condition coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="CO"/>
            <action coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0" species="empty"/>
            <action coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0" species="empty"/>
